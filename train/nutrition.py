...
from models.nutrition import Client, NutritionModel, Server
...
def local_learning(client_list, n_epochs):
    client_names, train_loaders, test_loaders = get_nutrition_data_loaders(batch_size=batch_size)
...
if __name__ == '__main__':
    ...
    local_learning(client_list=['asian'], n_epochs=50)
    ...
    # federated_learning(client_list=['mexican', 'spanish', 'white', 'black', 'asia'], communication_rounds=50,
    #                    epochs_per_round=1,
    #                    samples_data=None, sampling_types=['local', 'stratified'], saving=False,
    #                    saved_paras_idx=None)
